...
class MohaaStatsAPIClient
{
    ...
    public function getMultiple(array $requests): array
    {
        ...
        foreach ($requests as $key => $request) {
            ...
            $handles[$key] = ['handle' => $ch, 'url' => $url, 'cacheKey' => $cacheKey, 'schema' => $request['schema'] ?? null];
    ...
    public function deleteTrustedIP(int $forumUserId, int $ipId): ?array { return $this->delete('/auth/trusted-ip/' . $ipId, ['forum_user_id'=>$forumUserId], 'auth_success'); }
    public function resolvePendingIP(int $forumUserId, int $approvalId, string $action): ?array { return $this->post('/auth/pending-ip/resolve', ['forum_user_id'=>$forumUserId, 'approval_id'=>$approvalId, 'action'=>$action], 'auth_success'); }
    ...
    public function getRecentAchievements(): ?array { return $this->get('/achievements/recent', [], 'achievements_recent'); }
    public function getAchievementLeaderboard(): ?array { return $this->get('/achievements/leaderboard', [], 'achievements_leaderboard'); }
